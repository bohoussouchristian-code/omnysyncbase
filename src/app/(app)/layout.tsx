  ...
  return (
    <div className="flex flex-1 min-h-screen">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <header className="hidden lg:flex items-center justify-end gap-2 h-16 px-6 border-b border-slate-200 bg-white shrink-0">
          {user.role === "ADMIN" && <SettingsMenu theme="light" />}
